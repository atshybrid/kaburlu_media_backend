...
export async function sendToTokens(tokens: string[], payload: { title: string; body: string; data?: Record<string, string> }) {
...
export async function sendToUser(userId: string, payload: { title: string; body: string; data?: Record<string, string> }) {
...
export async function sendToTopic(topic: string, payload: { title: string; body: string; data?: Record<string, string> }) {
  const messaging = getMessaging();
  const message: any = {
    topic,
    notification: { title: payload.title, body: payload.body },
