-- Seed web article JSON prompt into Prompt table
-- Safe upsert to avoid duplicates

INSERT INTO "Prompt" ("id", "key", "content", "description", "createdAt", "updatedAt")
VALUES (
   'ai_web_article_json_default',
   'ai_web_article_json',
  $$You are a professional Article Formatter, SEO Optimizer, and News Writer.  
...
NOW OUTPUT THE FINAL JSON OBJECT.$$,
   'Web article JSON generation (ChatGPT/OpenAI variant). Placeholders: {TENANT_ID},{LANGUAGE_CODE},{AUTHOR_ID},{CATEGORY_IDS},{IMAGE_URLS},{IS_PUBLISHED},{RAW_CONTENT}',
   NOW(),
   NOW()
)
