...
const CONTENT = `You are a professional Article Formatter, SEO Optimizer, and News Writer.  
...
async function main() {
  await prisma.prompt.upsert({
    ...
    update: { content: CONTENT, description: 'Web article JSON generation with same-language body and Latin slug transliteration' },
    create: { key: 'ai_web_article_json', content: CONTENT, description: 'Web article JSON generation with same-language body and Latin slug transliteration' },
  });
  console.log('Updated ai_web_article_json prompt.');
}
